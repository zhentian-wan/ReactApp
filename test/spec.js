...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appComponentsNotesNotes = __webpack_require__(174);

	var _appComponentsNotesNotes2 = _interopRequireDefault(_appComponentsNotesNotes);
	...
	describe('Note', function () {
	    ...
	    beforeEach(function () {
	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_appComponentsNotesNotes2['default'], { username: 'zhentian-wan' }));
	    });

	    it('should display the correct artist name', function () {
	        expect(_reactAddons2['default'].findDOMNode(component).textContent).toMatch(/Notes for zhentian-wan/);
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(8);
	var ReactPropTypes = __webpack_require__(175).PropTypes;
